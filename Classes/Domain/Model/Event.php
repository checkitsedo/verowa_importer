...
class Event extends AbstractEntity
{
  ...
  {
    $this->organizer = $this->person ?: new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    $this->coorganizers = $this->person ?: new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    $this->childcarePerson = $this->person ?: new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    $this->subsPersonId = $this->person ?: new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    $this->rooms = $this->room ?: new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
  }
  ...
  /**
	 * Adds a organizer
	 *
	 * @param \Checkitsedo\VerowaImporter\Domain\Model\Person The contact to be added
	 * @return void
	 */
  public function addOrganizer(\Checkitsedo\VerowaImporter\Domain\Model\Person $organizer)
  {
  ...
  /**
	 * Remove a organizer
	 *
	 * @param \Checkitsedo\VerowaImporter\Domain\Model\Person The contact to be removed
	 * @return void
	 */
  public function removeOrganizer(\Checkitsedo\VerowaImporter\Domain\Model\Person $organizer)
  {
  ...
  /**
	 ...
	 * @return void
	 */
  public function addCoorganizer(\Checkitsedo\VerowaImporter\Domain\Model\Person $coorganizer)
  {
		$this->coorganizers->attach($coorganizer);
	}

  /**
	 * Remove a coorganizer
	 *
	 * @param \Checkitsedo\VerowaImporter\Domain\Model\Person The contact to be removed
	 * @return void
	 */
  public function removeCoorganizer(\Checkitsedo\VerowaImporter\Domain\Model\Person $coorganizer)
  {
		$this->coorganizers->detach($coorganizer);
	}
  ...
  /**
	 * Adds a room
	 *
	 * @param \Checkitsedo\VerowaImporter\Domain\Model\Room The room to be added
	 * @return void
	 */
  public function addRoom(\Checkitsedo\VerowaImporter\Domain\Model\Room $room)
  {
  ...
  /**
	 * Remove a room
	 *
	 * @param \Checkitsedo\VerowaImporter\Domain\Model\Room The room to be removed
	 * @return void
	 */
  public function removeRoom(\Checkitsedo\VerowaImporter\Domain\Model\Room $room)
  {
  ...
  /**
	 * Adds a file
	 *
	 * @param \Checkitsedo\VerowaImporter\Domain\Model\File The contact to be added
	 * @return void
	 */
  public function addFile(\Checkitsedo\VerowaImporter\Domain\Model\File $file)
  {
  ...
  /**
	 * Remove a file
	 *
	 * @param \Checkitsedo\VerowaImporter\Domain\Model\File The file to be removed
	 * @return void
	 */
  public function removeFile(\Checkitsedo\VerowaImporter\Domain\Model\File $file)
  {
